    ...
    <div className="flex flex-col w-full mt-2 space-y-4 px-4">
      <div className="flex flex-col md:flex-row justify-between mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4 md:mt-0">
          <Link prefetch={true} area-label="Link" href="/my-profile/address/new">
            <Button className="w-full sm:w-auto">Add Address</Button>
          </Link>
          <Link prefetch={true} area-label="Link" href={`/cart/checkout?reload=${Date.now()}`}>
          ...
          <Card key={address.id} className="w-full shadow-md">
            <CardHeader className="flex items-center justify-between p-4">
              ...
              <div className="flex space-x-2">
                <Link prefetch={true} area-label="Link" href={`/my-profile/address/${address.id}`}>
