...
export const AddressInfo = ({ addresses, label }: AddressInfoProps) => {
  return (
    <div className="flex flex-col w-full mt-40  space-y-4">
      <div className="flex justify-end">
        <h2 className="text-3xl font-semibold text-center w-full">{label}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-4">
        {addresses?.map((address, index) => (
          <Card key={address.id} className="w-full shadow-md">
            <CardHeader className="flex items-center flex-row justify-between p-4">
