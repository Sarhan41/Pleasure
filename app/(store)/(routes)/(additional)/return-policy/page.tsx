    ...
    <div className="bg-white lg:mt-14">
      <Container>
        <div className="px-4 lg:py-10 sm:px-6 lg:px-8">
          <h1 className="text-2xl font-bold text-primary">Return Policy</h1>
          <div className="mt-4 text-lg space-y-6">
            ...
            <div className="flex items-start space-x-2">
              ...
              <p>We do not accept returns on panties for hygiene reasons.</p>
            </div>
            <div className="flex items-start space-x-2">
              <FaRegCheckCircle className="text-primary mt-1" />
              <p>Other items like sports bras, camisoles, pajamas, and shorts can be returned within 30 days of purchase.</p>
            </div>
            <div className="flex items-start space-x-2">
              <FaRegCheckCircle className="text-primary mt-1" />
            ...
            <p>
              To initiate a return, please contact our customer service team at returns@example.com with your order number and reason for return. Our team will provide you with further instructions.
            </p>
            <p>
              Thank you for shopping with us. We appreciate your business and are here to help if you have any questions or concerns about our return policy.
            </p>
